...
$token = '9b74bd1ab0f32b4b6cb93b6b2e5af5a3e9c6';
...
$oauth_consumer_key = 'qyprd4OFga81URvkibIIYWTFzc2aFX';
//$oauth_consumer_secret = 'EKnGFvsd3qtyVt2R8s7ZEWrHpAQmRgrS1ed8vur7';
$oauth_consumer_secret = 'LOAjeDsW7ZiH19ZhUTin7GMBZWzeOJ3Bfbbk9ZjB';
...
$quickbooks_oauth_url = 'http://intuit.dev/quickbooks-php/docs/partner_platform/example_app_ipp_v3/oauth.php';

// This is the URL to forward the user to after they have connected to IPP/IDS via OAuth
$quickbooks_success_url = 'http://intuit.dev/quickbooks-php/docs/partner_platform/example_app_ipp_v3/success.php';

// This is the menu URL script 
$quickbooks_menu_url = 'http://intuit.dev/quickbooks-php/docs/partner_platform/example_app_ipp_v3/menu.php';
