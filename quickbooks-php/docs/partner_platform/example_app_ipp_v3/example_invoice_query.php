...
if ($Context = $IPP->context())
{
	...
	$invoices = $InvoiceService->query($Context, $realm, "SELECT * FROM Invoice STARTPOSITION 1 MAXRESULTS 10"); //  STARTPOSITION 1 MAXRESULTS 10
	//$invoices = $InvoiceService->query($Context, $realm, "SELECT * FROM Invoice WHERE DocNumber = '1002' ");
	//$invoices = $InvoiceService->query($Context, $realm, "SELECT * FROM Invoice WHERE txnId = '140' ");
